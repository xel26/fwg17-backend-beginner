...
app.use(cors({origin: "https://dapper-boba-9ec9d1.netlify.app"}))                                                           // menambahkan middleware ke rantai penanganan permintaan. setiap kali ada permintaan HTTP, cors akan di jalankan
